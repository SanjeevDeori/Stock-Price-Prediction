...
selected_stock = st.text_input('Enter Stock Name (e.g., AAPL, MSFT, META):', value='AAPL').upper()
...
if selected_stock:
    try:
        ...
        if data.empty:
            st.error("Invalid stock name or no data available. Please try another symbol.")
        else:
